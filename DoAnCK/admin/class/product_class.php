...
<?php
    class product{
        ...
        public function update_amount($product_id,$product_delta)
        {
            $query = "UPDATE tbl_product SET product_number = product_number + $product_delta  WHERE product_id = $product_id";
        ...
        {
            $query = "SELECT tbl_product.*, tbl_cartegory.cartegory_id, tbl_brand.brand_id
        ...
        {
            $query2 = "DELETE FROM tbl_product_img_desc WHERE product_id = $product_id";
            $res = $this -> db -> delete($query2);
